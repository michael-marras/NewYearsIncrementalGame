...
void SetupObjects(ObjectManager* objectManager, TextureManager* textureManager) {
    ...
    objectManager->RegisterObject(2, "winter_objects", 32, 32, 16, 16, false, "winter_medium_rock");
    ...
    objectManager->RegisterObject(5, "winter_objects", 96, 80, 16, 16, false, "winter_bush");
}
